            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" id="departments" method="POST" data-parsley-validate>
                                @csrf
                                @method('put')
                                <input type="hidden" name="departmentId" id="department_id" value="{{$department->id}}" class="form-control">
                                <div class="form-group row">
                                    <label for="example-text-input"
                                        class="col-sm-2 col-form-label">{{ __('admin.name_ar') }}</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $department->name_ar }}" type="text"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" value="{{ $department->name_en }}"
...
<script>
    $(function () {
        ...
        let name_en = $("input[name=name_en]").val();
            ...
            $('body').on('submit','#departments',function (e) {
                e.preventDefault();
                //  alert('asdasd');
