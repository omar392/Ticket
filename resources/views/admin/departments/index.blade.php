        ...
        <div class="page-title-box">
            ...
            <div class="row align-items-center">
                ...
                <div class="text-center">
                    <!-- Large modal -->
                    @if (Auth::guard('admin')->user()->hasPermission('departments-create'))
                        <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="modal"
                            data-target="#modal-add-department" style="margin-right: 20px;margin-left: 20px;"><i
                                class="fas fa-plus-circle" style="padding-inline-end: 5px;"></i>{{ __('admin.add') }}
                            {{ __('admin.department') }}</button>
                    @endif
                    <button type="button" class="btn btn-primary reload float-right mb-3"> <i class="fas fa-sync-alt"></i></button>
                </div>

                <!--  Modal content for the above example -->
                <div class="modal fade modal-add-department" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
                    aria-hidden="true" id="modal-add-department">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title mt-0" id="myLargeModalLabel">{{ __('admin.add') }}
                                    {{ __('admin.department') }}</h5>
                            ...
                            <div class="modal-body" id="modal-add-department">
                                <div class="modal-body">
                                    <div class="card-body">
                                        <form id="adddepartment" method="POST" data-parsley-validate>
                                            @csrf
                                            @method('post')
...
@push('js')
    ...
    <script>
        ...
        $('body').on('submit', '#adddepartment', function(e) {
            e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status == 'success') {
                            ...
                            $('#modal-add-department .close').click();
