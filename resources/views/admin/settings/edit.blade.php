                                ...
                                <form action="" id="settings" method="POST" data-parsley-validate>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input"
                                            class="col-sm-2 col-form-label">{{ __('admin.AWN') }}</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->AWN }}" type="text"
                                                name="AWN" id="example-text-input"
                                                placeholder="{{ __('admin.AWN') }} " required
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->facebook }}"
                                                ...
                                                placeholder="{{ __('admin.facebook') }}" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" value="{{ $setting->linkedin }}"
                                                ...
                                                placeholder="{{ __('admin.linkedin') }}" required
                                                parsley-trigger="change">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" name="image" id="image" value="{{ $setting->image }}"
                                                class="filestyle image" data-buttonname="btn-primary">
                                            <img src="{{ asset('dashboard/' . $setting->image) }}" width="340"
                                                height="200" alt="" style="margin-right: 70px;border-radius: 15px;"
                                                class="image-show" />
                                        </div>
                                    </div>
