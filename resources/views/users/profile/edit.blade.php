        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">{{ __('user.editprofile') }}</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item"><a href="{{ route('adminhome') }}">{{ __('admin.home') }}</a></li>
                            <li class="breadcrumb-item active">{{ __('user.editprofile') }}</li>
                        </ol>
                    </div>
                </div> <!-- end row -->
                <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="text" name="name" id="example-text-input"
                                                placeholder="{{ __('admin.name') }}" value="{{ Auth::user()->name }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control" type="number" name="phone" id="example-text-input"
                                                placeholder="{{ __('admin.phone') }}" value="{{ Auth::user()->phone }}"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
